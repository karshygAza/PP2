...
mickey = pygame.image.load('/Users/azamat/Documents/GitHub/PP2/LAB/lab7/mickeyclock.jpeg')
...
right_hand = pygame.transform.scale(right_hand, (320, 370))
left_hand = pygame.transform.scale(left_hand, (510, 355))
...
while running:
    ...
    right_hand_rect = right_hand_rotate.get_rect(center=(550,450))
